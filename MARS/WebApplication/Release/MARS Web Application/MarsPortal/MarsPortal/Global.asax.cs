...
namespace MarsPortal {
    public class Global:System.Web.HttpApplication {
        ...
        static void RegisterRoutes(RouteCollection routes) {
            ...
            // //vehicles abroad routes
            routes.MapPageRoute("VehiclesAbroadReservationDetails","VehiclesAbroad/ReservationDetails","~/App.Site/VehiclesAbroad/Details/ReservationDetails.aspx");
            routes.MapPageRoute("","VehiclesAbroad/VehicleDetails","~/App.Site/VehiclesAbroad/Details/VehicleDetails.aspx");
            routes.MapPageRoute("","VehiclesAbroad/ForeignNonRevenue","~/App.Site/VehiclesAbroad/ForeignNonRevenue/ForeignNonRevenue.aspx");
            routes.MapPageRoute("","VehiclesAbroad/FleetReservationMatch","~/App.Site/VehiclesAbroad/Match/FleetReservationMatch.aspx");
            routes.MapPageRoute("","VehiclesAbroad/ReservationFleetMatch","~/App.Site/VehiclesAbroad/Match/ReservationFleetMatch.aspx");
            routes.MapPageRoute("","VehiclesAbroad/FleetOverview","~/App.Site/VehiclesAbroad/Overview/FleetOverview.aspx");
            routes.MapPageRoute("","VehiclesAbroad/ReservationOverview","~/App.Site/VehiclesAbroad/Overview/ReservationOverview.aspx");
            routes.MapPageRoute("","VehiclesAbroad/ReservationAnalysis","~/App.Site/VehiclesAbroad/Reservations/ReservationAnalysis.aspx");
            routes.MapPageRoute("","VehiclesAbroad/ReservationBalance","~/App.Site/VehiclesAbroad/Reservations/ReservationBalance.aspx");
            routes.MapPageRoute("","VehiclesAbroad/ReservationDetails","~/App.Site/VehiclesAbroad/Reservations/ReservationDetails.aspx");
            routes.MapPageRoute("","VehiclesAbroad/UtilisationHistory","~/App.Site/VehiclesAbroad/UtilisationHistory/UtilisationHistory.aspx");
        ...
        protected void Session_Start(object sender,EventArgs e) {
            Rad.Web.Session.AccessDeniedUrl = "~/App.Site/Sizing/FutureTrend/FutureTrend.aspx";
        }
