...
namespace Mars.Pooling.Services {
    public class ResMainFilterService:MainFilterService<IReservationGridViewModel> {
        public ResMainFilterService(IReservationGridViewModel gridviewModel,ICmsOpsLogicModel cmsOpsModel,IThreeFilterCascadeModel carModel)
