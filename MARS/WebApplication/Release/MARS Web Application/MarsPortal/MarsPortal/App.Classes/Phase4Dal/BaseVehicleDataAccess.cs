...
namespace Mars.App.Classes.Phase4Dal
{
    public static class BaseVehicleDataAccess
    {
                        ...
                        , bool includeRev, bool includeNonRev)
        {
            ...
            //    vehicles = vehicles.Where(d => selectedOperStats.Contains(d.LastOperationalStatusId));
            //}
            ...
            //    vehicles = vehicles.Where(d => selectedMovementTypes.Contains(d.LastMovementTypeId));
            //}
