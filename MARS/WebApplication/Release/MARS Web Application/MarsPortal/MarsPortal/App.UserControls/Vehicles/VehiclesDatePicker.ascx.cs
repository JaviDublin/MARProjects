...
{
    public partial class VehiclesDatePicker : System.Web.UI.UserControl
    {
        ...
        protected void TextBoxDatePicker_TextChanged(object sender, EventArgs e)
        {
            SessionHandler.MappingSelectedStartDate = this.TextBoxDatePicker.Text;
