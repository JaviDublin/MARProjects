<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="VehiclesDatePicker.ascx.cs" Inherits="App.UserControls.Vehicles.VehiclesDatePicker" %>
...
<table cellpadding="0" cellspacing="0">
    <tr>
        <td style="padding-right: 5px;">
            <asp:TextBox ID="TextBoxDatePicker" runat="server" MaxLength="10" 
                CssClass="textBoxReportSettings" Width="80px" 
                ontextchanged="TextBoxDatePicker_TextChanged" AutoPostBack="True"></asp:TextBox>
        </td>
        <td>
