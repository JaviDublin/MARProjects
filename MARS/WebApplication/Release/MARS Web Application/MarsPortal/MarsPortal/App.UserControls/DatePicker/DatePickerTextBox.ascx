<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DatePickerTextBox.ascx.cs" Inherits="App.UserControls.DatePicker.DatePickerTextBox" %>
...
<table cellpadding="0" cellspacing="0">
    <tr>
        <td style="padding-right: 5px;">
            <asp:TextBox ID="TextBoxDatePicker" runat="server" MaxLength="10" CssClass="textBoxReportSettings" Width="80px"></asp:TextBox>
        </td>
        <td>
