                ...
                <tr>
                    <td class="rowPager" colspan="2">
                        ...
                        <div class="divPagerControl">
                            <uc:PagerControl ID="PagerControlVehiclesLease" runat="server" OnDropDownListPageSelectedIndexChanged="DropDownListPage_SelectedIndexChanged" OnDropDownListRowsSelectedIndexChanged="DropDownListRows_SelectedIndexChanged" OnPageIndexCommand="GetPageIndex" />
                        </div>
                    </td>
                </tr>
            </table>
