...
namespace App.UserControls.Mappings.Gridviews
{
    public partial class VehiclesLeaseGridView : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.PagerControlVehiclesLease.GridviewToPage = this.GridviewVehiclesLease;
            this.PagerControlVehiclesLease.GridviewSessionValues = (int)App.BLL.Gridviews.GridviewToPage.MappingVehiclesLease;
        }
        ...
        public void LoadVehiclesLeaseControl()
        {
            ...
            this.PagerControlVehiclesLease.PagerDropDownListRows.SelectedValue = "10";
        ...
        {
            MappingsVehiclesLease.SelectVehiclesLease(Convert.ToInt32(SessionHandler.MappingVehiclesLeasePageSize), Convert.ToInt32(SessionHandler.MappingVehiclesLeaseCurrentPageNumber),
                                        sortExpression, this.PanelVehiclesLease, this.PagerControlVehiclesLease.PagerButtonFirst, this.PagerControlVehiclesLease.PagerButtonNext, this.PagerControlVehiclesLease.PagerButtonPrevious, this.PagerControlVehiclesLease.PagerButtonLast, this.PagerControlVehiclesLease.PagerLabelTotalPages, this.PagerControlVehiclesLease.PagerDropDownListPage,
            this.GridviewVehiclesLease, this.LabelTotalRecordsDisplay, this.EmptyDataTemplateVehiclesLease, SessionHandler.MappingSelectedCountryOwner, SessionHandler.MappingSelectedCountryRent, SessionHandler.MappingSelectedStartDate, SessionHandler.MappingSelectedModelDescription);
        }
