<%@ Page Title="" Language="C#" MasterPageFile="~/App.MasterPages/Mars.Master" AutoEventWireup="true" 
    CodeBehind="ForeignVehicleSearch.aspx.cs" Inherits="Mars.App.Site.ForeignVehicles.ForeignVehicleSearch" %>
                                    ...
                                    <asp:UpdatePanel ID="upnlMultiview" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            ...
                                            <uc:NonRevOverviewGrid runat="server" ID="ucOverviewGrid" 
                                                ...
                                                ShowForeignVehicleFields="True" ShowApproveButton="False" />
        ...
        <tr style="vertical-align: top;">
            <td>
                <uc:AvailabilityParameters runat="server" ID="generalParams" ShowDayGrouping="False" 
                    ShowValuesAs="False" ShowLocationLogic="True" 
                    ShowVehicleFields="True" AllowMultiSelect="True"
                    ShowAdditionalFields="False" ShowOverdue="False"
                    ShowMovementTypes="False" ShowOperationalStatus="False" ShowForeignPredicament="True"
                     />
