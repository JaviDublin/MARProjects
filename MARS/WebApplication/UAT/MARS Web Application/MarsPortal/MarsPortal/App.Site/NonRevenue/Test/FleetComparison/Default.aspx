<%@ Page Title="" Language="C#" MasterPageFile="~/App.MasterPages/Application.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="App.Site.NonRevenue.Comparison.Fleet.Test.Default" %>
...
<asp:Content ID="ContentMain" ContentPlaceHolderID="ContentPlaceholderMainContent" runat="server">
      <asp:UpdatePanel ID="upChart" UpdateMode="Conditional" runat="server">
            <ContentTemplate>
                ...
                <uc:ChartControl ID="ccFleetComparison" runat="server" />
            </ContentTemplate>
        </asp:UpdatePanel>
