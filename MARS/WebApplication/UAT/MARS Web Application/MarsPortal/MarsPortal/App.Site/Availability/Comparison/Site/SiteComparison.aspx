<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SiteComparison.aspx.cs" MasterPageFile="~/App.MasterPages/Mars.Master"
        Inherits="Mars.App.Site.Availability.Comparison.Site.SiteComparison" %>
                        ...
                        <tr>
                            <td style="margin-top: 0; margin-bottom: auto; vertical-align: top;">
                                <div id="tabs-1">
                                    ...
                                    <ContentTemplate>
                                        <uc:ComparisonChart ID="ucComparisonChart" runat="server" SiteComparison="True" />
                                    </ContentTemplate>
                                    <triggers>
