<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="VehiclesCheckBoxList.ascx.cs" Inherits="App.UserControls.Vehicles.VehiclesCheckBoxList" %>
...
<asp:UpdatePanel ID="UpdatePanelPopupCheckBoxList" runat="server">
    <ContentTemplate>
        <table cellpadding="0" cellspacing="0">
            <tr>
                <td>
                    <asp:TextBox ID="TextBoxPopupCheckBoxList" runat="server" Width="95px" 
                        ReadOnly="false" CssClass="textBoxCheckBoxList" AutoPostBack="True" 
                        ontextchanged="TextBoxPopupCheckBoxList_TextChanged"></asp:TextBox>
                </td>
                <td>
        ...
        <asp:Panel ID="PanelPopupCheckBoxList" runat="server" CssClass="panelPopupCheckBoxList" Style="display: none;">
            <asp:Panel ID="PanelCheckBoxList" runat="server" CssClass="divPopUpCheckBoxList">
                <asp:CheckBoxList ID="CheckBoxListPopUp" runat="server" Width="108px" AutoPostBack="true">
                </asp:CheckBoxList>
            </asp:Panel>
        </asp:Panel>
