...
<asp:Content ID="ContentMain" ContentPlaceHolderID="ContentPlaceHolderContent" runat="server">
    <rad:Panel ID="PanelLogOn" runat="server" CssClass="panel-Login">
        ...
        <rad:LogOn ID="LogOnControl" runat="server" StyleTextBox="true"
            ...
            ImageHelpVisible="false" LogOnRememberMeChecked="True"  LogOnRememberMeVisible="false"
        ...
        <table>
            <tr>
                ...
                <td>
                    For any support issues, contact the <a target="_blank" href="http://intranet.hertz.com/hit/service-desk/default.aspx">Hertz Information Techonology Support Desk</a>
                </td>
            </tr>
        </table>
