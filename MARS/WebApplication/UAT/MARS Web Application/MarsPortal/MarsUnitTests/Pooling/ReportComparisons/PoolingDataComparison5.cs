...
{
    [TestClass]
    public class PoolingDataComparison5
    {
        private MainFilterEntity GetMainFilterExample()
        {
            var mfe = new MainFilterEntity { Country = "Germany", CmsLogic = true, CarSegment = "Car"};
            return mfe;
        }
        
        /// <summary>
        /// This is expected to show differencs as you can't compare site to fleet comparison when a Segment is chosen
        /// As this restricts the fleet comparison to cars groups linked to that country
        /// </summary>
        [TestMethod]
