<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PopupCheckBoxList.ascx.cs" Inherits="App.UserControls.CheckBoxList.PopupCheckBoxList" %>
...
<asp:UpdatePanel ID="UpdatePanelPopupCheckBoxList" runat="server">
    <ContentTemplate>
        <table cellpadding="0" cellspacing="0">
            <tr>
                <td>
                    <asp:TextBox ID="TextBoxPopupCheckBoxList" runat="server" Width="95px" ReadOnly="true" CssClass="textBoxCheckBoxList"></asp:TextBox>
                </td>
                <td>
        ...
        <asp:Panel ID="PanelPopupCheckBoxList" runat="server" CssClass="panelPopupCheckBoxList" Style="display: none;">
            <asp:Panel ID="PanelCheckBoxList" runat="server" CssClass="divPopUpCheckBoxList">
                <asp:CheckBoxList ID="CheckBoxListPopUp" runat="server" Width="108px">
                </asp:CheckBoxList>
            </asp:Panel>
        </asp:Panel>
        <asp:PopupControlExtender ID="PopUpControlExtenderCheckBoxList" runat="server" TargetControlID="TextBoxPopupCheckBoxList" PopupControlID="PanelPopupCheckBoxList" />
