...
namespace App.UserControls.DatePicker {
    public partial class DatePickerTextBox : System.Web.UI.UserControl {
        // reborn : 20 Feb 12
        // update : 21
        // DatePickerTextBox uses JSON and in integrated to javascript that is loaded and the same time
        ...
        public DateTime getDate() { // Return the date on of what's in the textbox as DateTime
