...
-- Description:	Loads the Export.GermanyForecast Table with a load of data that they require
				--Has a sister sp which selects the data as GEForecast
				--Requires (below) to send via csv file 
	--			BEGIN
	--				EXECUTE AS LOGIN = 'DIRDUB01\RAD_DBUSER'
	--				EXEC master..xp_cmdshell 'sqlcmd -S HESCMARSQ01 -d MARSPortal -E -Q "exec Export.GEForecast" -o "\\hescft02\EURawData\GEMARS\GEForecastData_Test9.csv" -s"," '
	--			END
-- =============================================
