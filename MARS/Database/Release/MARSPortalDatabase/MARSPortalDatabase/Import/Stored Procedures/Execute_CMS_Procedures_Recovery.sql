...
-- =============================================
CREATE PROCEDURE [Import].[Execute_CMS_Procedures_Recovery]
...
BEGIN
	...
	SELECT @data1	= 'Execute_CMS_Procedures - Complete 1 Recovery'
	...
	SELECT @key1	= convert(varchar(20),@@spid)
	SELECT @data1	= 'Execute_CMS_Procedures - Complete 2 Recovery'
	SELECT data2	= CONVERT(varchar(30),GETDATE(),113)
	INSERT Trace (Entity, key1, key2 , data1, data2)
	SELECT @entity, @key1, @key2 , @data1, @data2
	...
	SELECT @key1	= convert(varchar(20),@@spid)
	SELECT @data1	= 'Execute_CMS_Procedures - Complete 3 Recovery'
	SELECT data2	= CONVERT(varchar(30),GETDATE(),113)
	INSERT Trace (Entity, key1, key2 , data1, data2)
	SELECT @entity, @key1, @key2 , @data1, @data2
	...
	SELECT @key1	= convert(varchar(20),@@spid)
	SELECT @data1	= 'Execute_CMS_Procedures - Complete 4 Recovery'
	SELECT data2	= CONVERT(varchar(30),GETDATE(),113)
	INSERT Trace (Entity, key1, key2 , data1, data2)
	SELECT @entity, @key1, @key2 , @data1, @data2
	...
	SELECT @key1	= convert(varchar(20),@@spid)
	SELECT @data1	= 'Execute_CMS_Procedures - Complete 5 Recovery'
	SELECT data2	= CONVERT(varchar(30),GETDATE(),113)
	INSERT Trace (Entity, key1, key2 , data1, data2)
	SELECT @entity, @key1, @key2 , @data1, @data2
	...
	SELECT @key1	= convert(varchar(20),@@spid)
	SELECT @data1	= 'Execute_CMS_Procedures - Complete 6 Recovery'
	SELECT data2	= CONVERT(varchar(30),GETDATE(),113)
	INSERT Trace (Entity, key1, key2 , data1, data2)
	SELECT @entity, @key1, @key2 , @data1, @data2
	...
	SELECT @key1	= convert(varchar(20),@@spid)
	SELECT @data1	= 'Execute_CMS_Procedures - Complete 7 Recovery'
	SELECT data2	= CONVERT(varchar(30),GETDATE(),113)
	INSERT Trace (Entity, key1, key2 , data1, data2)
	SELECT @entity, @key1, @key2 , @data1, @data2
	...
	SELECT @key1	= convert(varchar(20),@@spid)
	SELECT @data1	= 'Execute_CMS_Procedures - Complete 8 Recovery'
	SELECT data2	= CONVERT(varchar(30),GETDATE(),113)
	INSERT Trace (Entity, key1, key2 , data1, data2)
	SELECT @entity, @key1, @key2 , @data1, @data2
	...
	SELECT @key1	= convert(varchar(20),@@spid)
	SELECT @data1	= 'Execute_CMS_Procedures - Complete 9 Recovery'
	SELECT data2	= CONVERT(varchar(30),GETDATE(),113)
	INSERT Trace (Entity, key1, key2 , data1, data2)
	SELECT @entity, @key1, @key2 , @data1, @data2
	...
	SELECT @key1	= convert(varchar(20),@@spid)
	SELECT @data1	= 'Execute_CMS_Procedures - Complete 10 Recovery'
	SELECT data2	= CONVERT(varchar(30),GETDATE(),113)
	INSERT Trace (Entity, key1, key2 , data1, data2)
	SELECT @entity, @key1, @key2 , @data1, @data2
	...
	SELECT @key1	= convert(varchar(20),@@spid)
	SELECT @data1	= 'Execute_CMS_Procedures - Complete 11 Recovery'
	SELECT data2	= CONVERT(varchar(30),GETDATE(),113)
	INSERT Trace (Entity, key1, key2 , data1, data2)
	SELECT @entity, @key1, @key2 , @data1, @data2
	...
	SELECT @key1	= convert(varchar(20),@@spid)
	SELECT @data1	= 'Execute_CMS_Procedures - Complete 12 Recovery'
	SELECT data2	= CONVERT(varchar(30),GETDATE(),113)
	INSERT Trace (Entity, key1, key2 , data1, data2)
	SELECT @entity, @key1, @key2 , @data1, @data2
	...
	SELECT @key1	= convert(varchar(20),@@spid)
	SELECT @data1	= 'Execute_CMS_Procedures - Complete 13 Recovery'
	SELECT data2	= CONVERT(varchar(30),GETDATE(),113)
	INSERT Trace (Entity, key1, key2 , data1, data2)
	SELECT @entity, @key1, @key2 , @data1, @data2
