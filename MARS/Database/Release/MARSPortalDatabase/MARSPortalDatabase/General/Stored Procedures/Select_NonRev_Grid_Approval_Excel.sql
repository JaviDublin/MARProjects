...
-- =============================================
CREATE PROCEDURE [General].[Select_NonRev_Grid_Approval_Excel]
...
BEGIN
	...
	(
		...
		ModelDesc			VARCHAR(500)	NULL,
		Plate				VARCHAR(50)		NULL,
		OperStat			VARCHAR(50)		NULL,
		NRDays				INT				NULL,
		Serial				VARCHAR(30)		NULL,
		RemarkText			VARCHAR(500)	NULL,
	...
	AND	(FNR.Fleet_carsales > 0 OR FNR.Fleet_rac_ttl > 0)
	and FNR.MoveType <> '-'
	ORDER BY 
		FNR.NRdays ASC
