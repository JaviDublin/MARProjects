CREATE TABLE [dbo].[FLEET_EUROPE_SUMMARY_ARCHIVE] (
    ...
    [FLEET_ADV]                      BIT          NULL,
    [FLEET_HOD]                      BIT          NULL,
    CONSTRAINT [FK_FLEET_EUROPE_SUMMARY_ARCHIVE_COUNTRIES] FOREIGN KEY ([COUNTRY]) REFERENCES [dbo].[COUNTRIES] ([country]),
    CONSTRAINT [FK_FLEET_EUROPE_SUMMARY_ARCHIVE_DateIndex] FOREIGN KEY ([REP_DATE]) REFERENCES [dbo].[DateIndex] ([REP_DATE])
);
...
GO
CREATE NONCLUSTERED INDEX [idx__FESH__REPDATE_MONTH_archive]
    ON [dbo].[FLEET_EUROPE_SUMMARY_ARCHIVE]([REP_DATE] ASC)
    INCLUDE([COUNTRY], [LOCATION], [CAR_GROUP], [FLEET_RAC_TTL], [FLEET_CARSALES], [ON_RENT_MAX_ABSOLUTE])
    ON [PRIMARY];


GO
CREATE CLUSTERED INDEX [idx_rep_date_archive]
    ON [dbo].[FLEET_EUROPE_SUMMARY_ARCHIVE]([REP_DATE] ASC)
