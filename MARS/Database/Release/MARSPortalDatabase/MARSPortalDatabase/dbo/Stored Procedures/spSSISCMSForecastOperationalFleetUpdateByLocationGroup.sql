...
-- =============================================
CREATE procedure [dbo].[spSSISCMSForecastOperationalFleetUpdateByLocationGroup]
...
--	==========================================================================
	...
	(
		...
		WHERE FC.REP_DATE >= @theDay 
			AND (FC.CMS_LOCATION_GROUP_ID = @CMS_LOCATION_GROUP_ID)
	) FC
	INNER JOIN
	(
		...
		WHERE (PD.CMS_LOCATION_GROUP_ID = @CMS_LOCATION_GROUP_ID)
...
-- EXEC [spSSISCMSForecastOperationalFleetUpdateByLocationGroup] '12/JUL,2011', 71, 1