...
-- =============================================
CREATE procedure [dbo].[spReportSiteComparisonCARHOLD_H]
...
BEGIN
	...
	CREATE TABLE #TMP_LOCATIONS(
		...
		TOPIC_COUNTER INT, --TOPIC: CARHOLD_H
	...
	SELECT 
		FES.REP_DATE, FES.COUNTRY, FES.LOCATION, SUM(FES.CARHOLD_H), SUM(FES.TOTAL_FLEET) 
	FROM 
