...
-- Author:		Gavin
-- Create date: 13/4/12
-- Description:	Returns the total count of car groups between @start_date and @end_date
--				according to the criteria. Further processing on return to get the average
--				per day or percentage per day is required
-- =============================================
CREATE PROCEDURE [dbo].[spReportFleetComparisonCarSegment]
