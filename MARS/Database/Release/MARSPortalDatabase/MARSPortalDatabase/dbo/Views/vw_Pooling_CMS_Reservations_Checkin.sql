...
CREATE VIEW [dbo].[vw_Pooling_CMS_Reservations_Checkin]
AS
...
FROM         dbo.vw_Pooling_Vehicles INNER JOIN
                      ...
                      dbo.vw_Pooling_Locations_CMS ON dbo.RESERVATIONS_EUROPE_ACTUAL.RTRN_LOC = dbo.vw_Pooling_Locations_CMS.location
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vw_Pooling_CMS_Reservations_Checkin';
...
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vw_Pooling_CMS_Reservations_Checkin';
...
Begin DesignProperties = 
   ...
   Begin DataPane = 
      ...
      Begin ColumnWidths = 39
         ...
         Width = 1500
         Width = 1500
         Width = 1500', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vw_Pooling_CMS_Reservations_Checkin';
