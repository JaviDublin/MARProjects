...
CREATE VIEW [dbo].[vw_Pooling_CMS_REA]
AS
SELECT     dbo.vw_Pooling_Locations_CMS.location, dbo.vw_Pooling_Locations_CMS.cms_location_group_id, dbo.vw_Pooling_Locations_CMS.cms_pool_id, 
                      ...
                      dbo.vw_Pooling_Locations_CMS.cms_pool, dbo.vw_Pooling_Locations_CMS.cms_location_group, dbo.vw_Pooling_Vehicles.car_group
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vw_Pooling_CMS_REA';
...
Begin DesignProperties = 
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vw_Pooling_CMS_REA';
