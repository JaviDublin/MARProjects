CREATE view [dbo].[vw_Pooling_OPS_Reservations_Checkin]
AS
SELECT     dbo.vw_Pooling_Locations_OPS.location, dbo.vw_Pooling_Locations_OPS.ops_area_id, dbo.vw_Pooling_Locations_OPS.ops_region_id, 
                      ...
                      dbo.RESERVATIONS_EUROPE_ACTUAL.RTRN_LOC, dbo.RESERVATIONS_EUROPE_ACTUAL.RS_ARRIVAL_DATE, 
                      ...
                      dbo.RESERVATIONS_EUROPE_ACTUAL.RES_VEH_CLASS, dbo.RESERVATIONS_EUROPE_ACTUAL.RATE_QUOTED, 
                      dbo.RESERVATIONS_EUROPE_ACTUAL.NEVERLOST, dbo.RESERVATIONS_EUROPE_ACTUAL.CUST_NAME, 
                      dbo.RESERVATIONS_EUROPE_ACTUAL.PHONE, dbo.RESERVATIONS_EUROPE_ACTUAL.CDPID_NBR, 
                      dbo.RESERVATIONS_EUROPE_ACTUAL.NO1_CLUB_GOLD, dbo.RESERVATIONS_EUROPE_ACTUAL.FLIGHT_NBR, 
                      dbo.RESERVATIONS_EUROPE_ACTUAL.REMARKS, dbo.RESERVATIONS_EUROPE_ACTUAL.N1TYPE
FROM         dbo.vw_Pooling_Vehicles INNER JOIN
                      ...
                      dbo.vw_Pooling_Locations_OPS ON dbo.RESERVATIONS_EUROPE_ACTUAL.RTRN_LOC = dbo.vw_Pooling_Locations_OPS.location
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vw_Pooling_OPS_Reservations_Checkin';
...
Begin DesignProperties = 
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vw_Pooling_OPS_Reservations_Checkin';
