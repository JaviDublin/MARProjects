...
CREATE procedure [dbo].[spReportFleetComparisonWS]
...
/*
exec spReportFleetComparisonWS
 @start_date = '20120105' ,
 @end_date = '20120105' ,
 @select_by = 'VALUE'
*/
...
declare @EndDateStart datetime
 ...
 SELECT 
  FES.dim_Calendar_id,  FES.CAR_GROUP, SUM(FES.WS), SUM(FES.TOTAL_FLEET), 1, 'd'
 FROM 
 ...
 begin
  INSERT INTO #TMP_CAR_GROUPS(dim_calendar_id, CAR_GROUP, TOPIC_COUNTER, GROUP_COUNTER, NumDays, rowtype)
  SELECT 
   FES.dim_Calendar_id_start,  FES.CAR_GROUP, SUM(FES.WS), SUM(FES.TOTAL_FLEET), max(FES.NumDays), 'm'
  FROM 
 ...
 begin
  INSERT INTO #TMP_CAR_GROUPS(dim_calendar_id, CAR_GROUP, TOPIC_COUNTER, GROUP_COUNTER, NumDays, rowtype)
  SELECT 
   FES.dim_calendar_id,  FES.CAR_GROUP, SUM(FES.WS), SUM(FES.TOTAL_FLEET), max(FES.NumDays), 'm'
  FROM 
