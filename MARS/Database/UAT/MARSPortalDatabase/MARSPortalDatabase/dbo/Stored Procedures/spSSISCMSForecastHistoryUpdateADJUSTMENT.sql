...
-- =============================================
CREATE procedure [dbo].[spSSISCMSForecastHistoryUpdateADJUSTMENT]
...
BEGIN
--	=========================================================================
--	Update OnRent_AT(current) in MARS_CMS_FORECAST_History table from FES table
--	==========================================================================
	...
	(
		...
		SELECT FCA.REP_DATE, FCA.COUNTRY, FCA.CMS_LOCATION_GROUP_ID, FCA.CAR_CLASS_ID
			, FCA.ADJUSTMENT_TD, FCA.ADJUSTMENT_BU1, FCA.ADJUSTMENT_BU2, FCA.ADJUSTMENT_RC
	...
	-- update ONRENT_AT
	WHEN MATCHED THEN
	UPDATE SET [TARGET].ADJUSTMENT_TD = [SOURCE].ADJUSTMENT_TD	
