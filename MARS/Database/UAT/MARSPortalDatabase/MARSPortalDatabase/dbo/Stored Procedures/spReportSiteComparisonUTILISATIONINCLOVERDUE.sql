...
-- =============================================
CREATE procedure [dbo].[spReportSiteComparisonUTILISATIONINCLOVERDUE] 
...
BEGIN
	...
	SELECT 
		FES.REP_DATE, FES.COUNTRY, FES.LOCATION, SUM(FES.ON_RENT + FES.OVERDUE), SUM(FES.OPERATIONAL_FLEET) 
	FROM 
