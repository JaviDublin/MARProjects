...
-- =============================================
CREATE procedure [dbo].[spReportSiteComparisonBD]
...
BEGIN
	...
	SELECT FES.REP_DATE, FES.COUNTRY, FES.LOCATION, SUM(FES.BD), SUM(FES.OPERATIONAL_FLEET) FROM FLEET_EUROPE_SUMMARY_HISTORY AS FES
	WHERE
