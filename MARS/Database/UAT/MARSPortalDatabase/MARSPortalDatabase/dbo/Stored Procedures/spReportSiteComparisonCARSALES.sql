...
-- =============================================
CREATE procedure [dbo].[spReportSiteComparisonCARSALES]
...
BEGIN
	...
	CREATE TABLE #TMP_LOCATIONS(
		...
		TOPIC_COUNTER INT, --TOPIC: CARSALES
	...
	SELECT 
		FES.REP_DATE, FES.COUNTRY, FES.LOCATION, SUM(FES.CARSALES), SUM(FES.TOTAL_FLEET) 
	FROM 
