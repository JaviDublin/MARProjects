...
BEGIN
	SET NOCOUNT ON;
	    ...
	    WITH 
		VehicleStatus as (
	select cg.car_group_id as CarGroupId, v.LastLocationCode, v.VehicleFleetTypeId
	...
	group by cg.car_group_id, v.LastLocationCode, v.VehicleFleetTypeId
	)
	...
	SELECT getdate() as Timestamp, v.CarGroupId, l.dim_Location_id, v.VehicleFleetTypeId
	...
	group by v.CarGroupId, l.dim_Location_id, v.VehicleFleetTypeId
END