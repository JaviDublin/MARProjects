...
-- Description:	Pooling - Status - Overdue collections - 30 Day Actuals
-- This is calculated from FEA
-- =============================================
CREATE FUNCTION [dbo].[fnPoolingStatusGetOverdueCollections30DayActuals]
(
...
ELSE
	...
	-- Return Result
		...
		-- The Overdue collections result to return
		RETURN @result
