...
-- Description:	Pooling - Status - Overdue open trips due - 3 Day Actuals
-- This is calculated from FEA
-- =============================================
CREATE FUNCTION [dbo].[fnPoolingStatusGetOverdueOpenTripsDue3DayActuals]
(
...
ELSE
	...
	-- Return Result
	BEGIN		
		-- The Overdue open trips due result to return
		RETURN @result
	END
END