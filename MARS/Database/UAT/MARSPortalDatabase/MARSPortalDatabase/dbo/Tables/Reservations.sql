...
GO
CREATE NONCLUSTERED INDEX [ReturnDate]
    ON [dbo].[Reservations]([ReturnDateTime] ASC);


GO
CREATE NONCLUSTERED INDEX [ArrivalDate]
    ON [dbo].[Reservations]([ArrivalDateTime] ASC);


GO
CREATE NONCLUSTERED INDEX [ArrDateWithLocations]
    ON [dbo].[Reservations]([RS_ARRIVAL_DATE] ASC)
    INCLUDE([RENT_LOC], [RTRN_LOC]);
