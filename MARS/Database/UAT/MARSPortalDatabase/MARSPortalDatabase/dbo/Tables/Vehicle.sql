...
GO
CREATE TRIGGER TriggerNonRevStatusInserted ON  [Vehicle]
FOR INSERT
AS  
begin

	select VehicleId, LastChangeDateTime, LastOperationalStatusId, LastMovementTypeId, LastLocationCode
	...
	INSERT INTO VehicleNonRevPeriodEntry(VehicleNonRevPeriodId, OperationalStatusId, MovementTypeId
				, LastLocationCode, [TimeStamp], LastChangeDateTime)
	SELECT nrp.VechicleNonRevPeriodId, LastOperationalStatusId, LastMovementTypeId, LastLocationCode, getdate(), vid.LastChangeDateTime
...
GO
CREATE TRIGGER TriggerNonRevStatusChanged ON  [Vehicle]
FOR UPDATE
AS  
begin
	...
	select p.VechicleNonRevPeriodId, v.NewLastOperationalStatusId, v.NewLastMovementTypeId,
		NewLastLocationCode, getdate(), v.NewLastChangeDateTime
	from #VehiclesThatHaveChangedStatus v
