CREATE TABLE [Inp].[Fact_FLEET_EUROPE_SUMMARY_HISTORY_Month] (
...
GO
CREATE CLUSTERED INDEX [ix_Fact_FLEET_EUROPE_SUMMARY_HISTORY_Month]
    ON [Inp].[Fact_FLEET_EUROPE_SUMMARY_HISTORY_Month]([dim_Calendar_id] ASC);
