CREATE TABLE [Inp].[Fact_FLEET_EUROPE_SUMMARY_HISTORY_Month_DOW] (
...
GO
CREATE CLUSTERED INDEX [ix_Fact_FLEET_EUROPE_SUMMARY_HISTORY_Month_DOW]
    ON [Inp].[Fact_FLEET_EUROPE_SUMMARY_HISTORY_Month_DOW]([dim_Calendar_id] ASC, [Rep_DayOfWeek] ASC);
