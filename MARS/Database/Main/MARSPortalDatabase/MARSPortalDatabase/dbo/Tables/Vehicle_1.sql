CREATE TABLE [dbo].[Vehicle] (
    ...
    CONSTRAINT [FK_Vehicle_LOCATIONS] FOREIGN KEY ([LastLocationId]) REFERENCES [dbo].[LOCATIONS] ([dim_Location_id]),
...
GO
CREATE NONCLUSTERED INDEX [OwningCountry]
    ON [dbo].[Vehicle]([OwningCountry] ASC);


GO
CREATE NONCLUSTERED INDEX [LastLocationId]
    ON [dbo].[Vehicle]([LastLocationId] ASC);


GO
CREATE NONCLUSTERED INDEX [LastLocation]
    ON [dbo].[Vehicle]([LastLocationCode] ASC);


GO
CREATE NONCLUSTERED INDEX [IsFleetIndex]
    ON [dbo].[Vehicle]([IsFleet] ASC);


GO
CREATE NONCLUSTERED INDEX [CarGroup]
    ON [dbo].[Vehicle]([CarGroup] ASC);
