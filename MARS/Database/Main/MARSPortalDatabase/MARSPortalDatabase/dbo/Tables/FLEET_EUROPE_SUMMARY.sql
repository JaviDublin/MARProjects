CREATE TABLE [dbo].[FLEET_EUROPE_SUMMARY] (
    ...
    [FLEET_ADV]                      BIT          NULL,
    [FLEET_HOD]                      BIT          NULL,
    CONSTRAINT [FK_FLEET_EUROPE_SUMMARY_COUNTRIES] FOREIGN KEY ([COUNTRY]) REFERENCES [dbo].[COUNTRIES] ([country])
);
...
GO
CREATE CLUSTERED INDEX [idx_rep_date_s]
    ON [dbo].[FLEET_EUROPE_SUMMARY]([REP_DATE] ASC)
    ON [scheme_fleet_partition_month] ([REP_DATE]);


GO
CREATE NONCLUSTERED INDEX [idx__FES__REPDATE_MONTH]
    ON [dbo].[FLEET_EUROPE_SUMMARY]([REP_DATE] ASC)
