CREATE TABLE [Fao].[MaxFleetFactor] (
    ...
    [MaxFleetFactorScenarioId] INT          NOT NULL,
    ...
    CONSTRAINT [FK_MaxFleetFactor_MaxFleetFactorScenario] FOREIGN KEY ([MaxFleetFactorScenarioId]) REFERENCES [Fao].[MaxFleetFactorScenario] ([MaxFleetFactorScenarioId]),
...
CREATE UNIQUE NONCLUSTERED INDEX [UniqueIndex]
    ON [Fao].[MaxFleetFactor]([MaxFleetFactorScenarioId] ASC, [LocationId] ASC, [CarGroupId] ASC, [DayOfWeekId] ASC);
