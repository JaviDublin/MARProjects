...
(
	...
	SELECT [GroupedPeakData].[LocationId]
		...
		, ([GroupedPeakData].[value] * [Mcs].[Percentage] * 
				(case when RevenueGroupedByCarGroup.[value] = 0 then 0 else 
				[RevByGroupedPeak].[GrossRevenue] / RevenueGroupedByCarGroup.[value] end)) as MinNessesaryFleet
